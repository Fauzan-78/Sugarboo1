...
<?php
$query_id_transaksi_2 = "SELECT * FROM detail_transaksi_ambil where id_transaksi = $id_transaction";
$result2 = mysqli_query($conn,$query_id_transaksi_2);
if($result2){
    while($row2 = mysqli_fetch_assoc($result2)){
        $letak_toko = $row2['letak_toko'];
        $waktu_pengambilan = $row2['waktu_pengambilan'];
        $jam_pengambilan = $row2['jam_pengambilan'];
        $catatan = $row2['catatan'];
?>
        <div class="kotak_transaksi_2">
            <span>letak toko&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :  &nbsp;&nbsp;&nbsp;&nbsp;<?= $letak_toko ?></span>
            <span>waktu pengambilan&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :  &nbsp;&nbsp;&nbsp;&nbsp; <?= $waktu_pengambilan ?> </span>
            <span>jam pengambilan&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :  &nbsp;&nbsp;&nbsp;&nbsp; <?= $jam_pengambilan ?> </span>
        </div>
    </div>
    <div class="catatan">
