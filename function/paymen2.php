...
if(isset($_POST["submit"])){
    ...
    $email          = $_POST['email'];
    $jenis_pengiriman = "ambil di tempat";
   ...
   //masukin identitas transaksi ke database id_transaksi
    ...
    $toko = $_POST['toko_pengambilan'];
    $waktu         = $_POST['waktu'];
    $jam           = $_POST['jam'];
    $catatan     = $_POST['catatan'];

    $input_detail_transaksi_2 = "INSERT INTO detail_transaksi_ambil(id_transaksi, letak_toko,waktu_pengambilan, jam_pengambilan, catatan) VALUES (' $highest_id','$toko ','$waktu','$jam','$catatan')";
    if($result_detai_2l =  mysqli_query($conn,$input_detail_transaksi_2)){
...
<html lang="en">
  ...
  <section id="navigasi">
    ...
    <form id="form" action="paymen2.php" method="POST"  enctype="multipart/form-data" >
    <div class="pembayaran">
     ...
     <!-- Pembayaran sebelah kanan -->
      ...
      <div class="header-biodata">
        ...
        <div class="input-control">
          <label for="wilayah_pemesanan">Pilih Toko Pengambilan</label>

          <select name="toko_pengambilan" id="toko_pengambilan" placeholder="Toko Pengambilan"  required>
               <?php
              $query_toko= mysqli_query($conn,"SELECT nama_toko,wilayah from toko");
              if(mysqli_num_rows($query_toko)>0){

                foreach ($query_toko as $key) {
                 ?>
                 <option value="<?php echo $key['nama_toko'] ?>"><?php echo $key['nama_toko'] ?> - <?php echo $key['wilayah'] ?></option>
                 <?php
                }
              }
                ?>
        ...
        <div class="input-control">
          <label for="waktu">pilih hari pengambilan <b>(tekan logo calender)</b></label>
      ...
      <div class="input-control">
          <label for="jam">pilih waktu pengambilan<b>(tekan logo jam)</b></label>
